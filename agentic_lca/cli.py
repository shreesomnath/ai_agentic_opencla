...
def main():
    ...
    if "--test-connection" in sys.argv or "-t" in sys.argv:
        ...
        try:
            ...
            print(" 1. Ensure openLCA is open and running on your system.")
            print(" 2. In openLCA, navigate to: File -> Tools -> Developer Tools -> IPC Server.")
            print(" 3. Choose a port (default: 8080) and click 'Start' to listen for connections.")
            
            # Suggest scanning local ports
    ...
    try:
        ...
        try:
            executor = LcaExecutor(port=port)
            # Try a quick test call to verify responsiveness
